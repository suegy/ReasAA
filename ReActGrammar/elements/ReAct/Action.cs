...
{
    public class ReActAction : AGene
    {
        public ReActAction(Configuration config, object value)
        ...
        public ReActAction(IChromosome chrom, Configuration config, object value)
            : this(config,value)
        {
            SetChromosome(chrom);
        }
        ...
        {
            return new ReActAction(gpConfig, value);
        }
