...
namespace ReAct.Grammar.elements.ReAct
{
    public class GPPlanBuilder
    {
        ...
        public List<ReActAction> actions { private set; get; }
        public List<ReSense> senses { private set; get; }
        ...
        public DriveCollection Build(IChromosome chrom, Configuration config)
        {
            ...
            Dictionary<string, FixedGroup> actionPatterns = BuildActionPatternStubs(chrom, config);
        ...
        internal DriveCollection BuildDriveCollection(IChromosome chrom, Configuration config, Dictionary<string,Competence> competences, Dictionary<string,FixedGroup> actionPatterns)
        {
        ...
        internal Dictionary<string, FixedGroup> BuildActionPatternStubs(IChromosome chrom, Configuration config)
        {
            ...
            foreach (KeyValuePair<string,Tuple<string,long,List<object>>> pair in this.actionPatterns )
                ...
                // FIXME: @swen: this is an actual issue as the plan allows setting a timeout which the engine currently is ignoring
                patternStubs[pair.Key] = new FixedGroup(chrom,config,pair.Key);
        ...
        internal CompetenceElement BuildCompetenceElement(IChromosome chrom, Configuration config, Tuple<string, List<object>, string, int> element,
            Dictionary<string,Competence> competences, Dictionary<string,FixedGroup> actionPatterns)
        {
        ...
        internal ReSense BuildSenseAct(IChromosome chrom, Configuration config, string senseName)
        {
            ReSense sense = new ReSense(chrom, config, senseName);
        ...
        /// </exception>
        internal ReSense BuildSense(IChromosome chrom, Configuration config, Tuple<string, string, string> senseStruct)
        {
            ReSense sense = new ReSense(chrom, config, senseStruct.First);
        ...
        /// new ReAction object from the agent's behaviour
        ...
        /// <param name="competences">A competence object dictionary.</param>
        /// <param name="actionPatterns">An element grouping object dictionary.</param>
        /// <returns>The element with the given name either ReAction, Competence 
        ///     or FixedGroup.</returns>
        /// <exception cref="NameException">
            ...
            Dictionary<string,FixedGroup> actionPatterns)
        {
            ...
            try
            {
                element = new ReActAction(chrom, config, name);
