...
{
    public class ReSense : AGene
    {
        public ReSense(Configuration config, object value) 
...

        {
         ...
         public ReSense(IChromosome chrom, Configuration config, object value) 
             : this(config,value)
         {
             SetChromosome(chrom);
         }
        ...
        public override object Clone()
        {
            ...
            return new ReSense(gpConfig,value);
