    ...
    class ModelFactory
    {
        ...
        */
        ...
        public IEditable CreateActionPattern(string name, TimeUnit timeUnit, IEditable[] children = null, bool isEnabled = true)
        {
            ...
            ActionPattern ap = new ActionPattern(id, name, timeUnit);
        ...
        internal IEditable CloneActionPattern(ActionPattern actionPattern)
        {
            ActionPattern clone = (ActionPattern)CreateActionPattern(actionPattern.GetName(),actionPattern.getTimeUnit());
        ...
        private ActionPattern ConstructActionPattern(Tuple<string, long, List<object>> rawAP, Dictionary<string, Tuple<string, long, List<object>, List<Tuple<string, List<object>, string, int>[]>>> rawComps, Dictionary<string, Tuple<string, long, List<object>>> rawAPs)
        {
            ActionPattern ap = (ActionPattern)CreateActionPattern(rawAP.First, (TimeUnit)CreateTimeUnit("ms", rawAP.Second));
        ...
        private IEditable ConstructRecursiveAction(string actionToken, Dictionary<string, Tuple<string, long, List<object>, List<Tuple<string, List<object>, string, int>[]>>> rawComps, Dictionary<string, Tuple<string, long, List<object>>> rawAPs)
        {
            ...
            // checking if the action of the competence is either another competence an action pattern or an action element
